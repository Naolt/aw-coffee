  ...
  return (
    <footer className="bg-white text-brown py-16 border-t border-brown/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-[2fr_1fr_1fr] gap-12">
          ...
          <div>
            ...
            <p className="text-brown/80 mb-6 leading-relaxed">
              High-elevation, forest-grown Ethiopian Arabica with full traceability.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-brown/80 hover:text-green transition-colors">
                  Home
                </Link>
              </li>
              <li>
        ...
        {/* Bottom Copyright */}
        <div className="mt-12 pt-8 border-t border-brown/10 text-center text-brown/60 text-sm">
          <p>&copy; {new Date().getFullYear()} AW Coffee. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
